...
var SinMH = function ($) {
  ...
  function getChapterImage(page) {
    ...
    if (filename.match(/^https?:\/\/(images.dmzj.com|imgsmall.dmzj.com)/i)) return 'https://imgdm.eshanyao.com/showImage.php?url=' + encodeURI(filename);
    if (filename.match(/^[a-z]\//i)) return 'https://imgdm.eshanyao.com/showImage.php?url=' + encodeURI("https://images.dmzj.com/" + filename);
